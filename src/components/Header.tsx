...
const HeaderForDesktop = () => {
  ...
  return (
    <header className=" h-fit flex flex-col  px-4  py-2 shadow-md shadow-blue-900 w-screen">
      <nav className=" backdrop-blur-3xl items-center flex justify-between w-full  ">
        <Image
