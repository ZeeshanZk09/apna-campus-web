...
const successStories = [
  {
    ...
    stat: "73%",
    description:
      "of career changers landed a new role within 6 months of completing their course.",
  },
  {
    icon: TrendingUp,
    ...
    stat: "45%",
    description:
      "average salary increase reported by graduates within their first year.",
  },
  {
    icon: Award,
    ...
    stat: "12K+",
    description:
      "verified certificates awarded to successful graduates across all programs.",
  },
];
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 sm:pt-20 sm:pb-24">
        ...
        >
          ...
          >
            Discover how Apna Campus has helped thousands of learners transform
        ...
        >
          {filteredTestimonials.map((testimonial) => (
            ...
            >
              <Quote
                size={32}
                className="text-indigo-200 dark:text-indigo-800 mb-4"
              />
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-lg text-indigo-100 max-w-2xl mx-auto mb-8">
              ...
              careers with Apna Campus. Your success story starts here.
            </p>
