...
export default function HomeHero() {
  ...
  const heading = (
    <h1 className='text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight'>
      ...
      <span className={`block text-gray-400`}>with Quality Learning</span>
    </h1>
  );

  return (
    <section className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  pb-10 text-gray-200'>
      <div
        className={`rounded-2xl ${
          isDarkMode
            ? 'bg-white/6 backdrop-blur-md border border-white/8'
            : 'bg-black/6 backdrop-blur-md border border-black/8'
        } px-16 mt-8 shadow-lg`}
      >
        <div className='grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-12'>
          ...
          >
            ...
            <p className='mt-4 sm:mt-6 text-gray-500 max-w-xl'>
            ...
            <div className='mt-6 flex items-center gap-4 flex-wrap'>
              ...
              <Link
                href='#courses'
                className='text-gray-500 inline-flex items-center justify-center rounded-md border border-gray-600 px-4 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-300'
              >
                Explore Courses
              </Link>
            </div>
            ...
            <ul className='mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-gray-600 max-w-md'>
              <li className='flex items-start gap-3'>
                ...
                <span>
                  Mentor-led projects <span className='text-gray-400'>— real-world practice</span>
                </span>
              </li>
              ...
              <li className='flex items-start gap-3'>
                ...
                <span>
                  Certificate of completion <span className='text-gray-400'>— shareable</span>
                </span>
              </li>
              ...
              <li className='flex items-start gap-3'>
                ...
                <span>
                  Active community <span className='text-gray-400'>— get help fast</span>
                </span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className='w-full max-w-md'>
              <div className='relative rounded-2xl overflow-hidden'>
                ...
                <div className='transform -translate-y-16 text-xs text-gray-500 text-center'>
