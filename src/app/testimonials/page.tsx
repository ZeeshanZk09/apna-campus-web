    ...
    <section className="px-20 flex   justify-between items-center min-h-screen w-screen">
      <div className="max-w-[50%] flex flex-col gap-10">
        ...
        <p>
          ...
          omnis repellat voluptas autem pariatur molestiae reprehenderit,
          corrupti nihil praesentium facilis amet inventore soluta saepe.
          Voluptate, eveniet id. Facilis, quaerat officia?
        </p>
      </div>
      <Card />
    </section>
