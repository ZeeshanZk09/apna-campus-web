...
/**
  ...
  /**
   * `prisma.teacherCohort`: Exposes CRUD operations for the **TeacherCohort** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more TeacherCohorts
    * const teacherCohorts = await prisma.teacherCohort.findMany()
    * ```
    */
  get teacherCohort(): Prisma.TeacherCohortDelegate<ExtArgs, { omit: OmitOpts }>;
