...
import { useGetUserProfile } from "@/hooks/useUserQueries";
...
function formatDate(
  dateInput: string | number | Date | FormatDateInput,
): string {
  ...
  if (Number.isNaN(date.getTime())) {
    ...
    const isoDate = new Date(
      (dateInput as FormatDateInput)?.toString?.() ?? "",
    );
    return !Number.isNaN(isoDate.getTime())
      ? isoDate.toLocaleDateString()
      : "N/A";
  }
...
export default function ProfilePage() {
  ...
  const handleCoverPicChange = async (
